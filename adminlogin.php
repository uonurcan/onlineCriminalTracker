                    ...
                    <div class="card-body p-0">
                        <div class="row">
                            <div class="col-lg-6 d-none d-lg-flex">
                                <div class="flex-grow-1 bg-login-image " style="background: url(&quot;admin/assets/img/1-removebg-preview.jpg&quot;) center no-repeat;"></div>
                            </div>
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <form class="user"  action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
                                        <div class="mb-3">
                                            <input class="form-control form-control-user" required id="email" type="text"aria-describedby="emailHelp" placeholder="Enter Username... (admin)" name="username"></div>
                                        <div class="mb-3">
                                            <input class="form-control form-control-user" required type="password" id="password" placeholder="Password (admin)" name="password"></div>
                                        <div class="mb-3">
